...
theme_tcdl <-theme(text = element_text(family = "Helvetica", size = 12),
        ...
        axis.text = element_text(color = "grey", size = 11, family  =  "Helvetica"),
        ...
        strip.text = element_text(colour = 'white', family = 'Helvetica', size = 10)
)
...
theme_pub <-theme(text = element_text(family = "Helvetica", size = 16),
        panel.grid.major.x = element_line(colour = "#ECECEC", size = 0.4, linetype = 1),
        panel.grid.minor.x = element_blank(),
        panel.grid.minor.y = element_blank(),
        panel.grid.major.y = element_line(colour = "#ECECEC", size = 0.4, linetype = 1),
        legend.title = element_text(size = 16, colour  =  "#8B8B8B"),
        legend.key = element_rect(fill = "transparent", colour = NA),
        legend.background = element_rect(fill = "transparent", colour = NA),
        legend.key.size = unit(1, "lines"),
        legend.text = element_text(size = 16, colour  =  "#8B8B8B"),
        axis.text = element_text(color = "grey", size = 16, family  =  "Helvetica"),
        ...
        plot.background = element_rect(colour = NA, fill = 'transparent'),
        strip.background = element_rect(colour = 'grey', fill = 'grey'),
        strip.text = element_text(colour = 'white', family = 'Helvetica', size = 16)
)
