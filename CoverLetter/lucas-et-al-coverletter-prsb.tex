...
In this study we have used epidemiological simulations to examine whether these factors contribute equally to the ability of a new pathogen to invade into a population in the presence of a competing endemic pathogen and therefore to increase the pathogen richness of the host species. 
We found that while empirical studies tend to measure population density, it is in fact population size that controls the probability of pathogen invasion, and therefore pathogen richness.
We furthermore found that it is specifically larger groups that allow large populations to allow pathogen invasion; large populations divided into many small groups will not promote pathogen richness to the same extent.
Our study has implications for public health researchers studying zoonotic diseases, epidemiologists interested in multipathogen systems as well as ecologists studying both the basic science of pathogen richness in wild animals and the effects of global change on pathogen communities.
